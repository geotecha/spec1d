...
#    import os
#    
#    p = os.path.join(r"C:\Users\Rohan Walker\repo\spec1d")
#    print p
#    #it seems you need -dpath to pass a string
#    ar = ['-d', p , p]
#    #ar = [p]
#    #ar = ['-d', 'C:\Users\Rohan Walker\repo\spec1d\docs', 'C:\Users\Rohan Walker\repo\spec1d\docs\source\generated','-n']
#    #ar = ['-d', 'C:\Users\Rohan Walker\repo\spec1d\docs'] 
#    ar = ['--no_recursion', '--dirs','C:\\Users\\Rohan Walker\\repo\\spec1d\\docs']
#    #ar = ['-v']  
#    ar = ['-d', os.path.join(r"C:\Users\Rohan Walker\repo\spec1d\docs")]    
#    ar = ['-n', '-d', os.path.join(r"C:\Users\Rohan Walker\repo\spec1d\docs\source") ]    
#    print ar
#    main(ar)       