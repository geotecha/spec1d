...
"""
Script/Function to auto document spec1d python package.
...
project_name = "One Dimensional spectral consolidation"
...
def main():
    ...
    will be created in a folder called spec1d\docs\auto.  Must be run in 
    the spec1d/tools directory.
    ...
    if not (basename == 'tools' and 
            os.path.basename(dirname) == 'spec1d'):
        print('script will only work from .../spec1d/tools. Script aborted.')
        sys.exit(1)
